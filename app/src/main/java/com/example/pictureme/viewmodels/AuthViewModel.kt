...
class AuthViewModel @Inject constructor (
    ...
    private val _authLiveData = MutableLiveData<Resource<FirebaseUser>?>()
    val authLiveData: LiveData<Resource<FirebaseUser>?> = _authLiveData
...
//    }
    ...
    fun login(email: String, password: String) = viewModelScope.launch {
        _authLiveData.value = Resource.Loading
